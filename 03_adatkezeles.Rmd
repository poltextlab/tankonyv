...
Az így kiválogatott változókból létrehozhatunk és objektumként eltárolhatunk egy új adattáblát, amivel azután tovább dolgozhatunk, vagy kiírathatjuk például `.csv` fájlba, vagy elmenthetjük a `saveRDS` segítségével.
